...
export default function Dialog(props) {
    ...
    return (
        <Modal ref={modal} onClose={closeHandler}>
            {display? (
                <div ref={wrapperRef} className={cls} onClick={clickHandler} onAnimationEnd={animationendHandler}>
                    <header className='flex justify-between items-center mb-2'>
                        <div className='font-bold text-lg leading-6'>
                            {title}
                        </div>
                        <div onClick={closeHandler} className='p-2 rounded-md cursor-pointer trainsition hover:bg-gray-200'>
